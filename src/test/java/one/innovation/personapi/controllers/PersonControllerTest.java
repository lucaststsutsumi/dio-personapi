...
import one.innovation.personapi.controller.PersonController;
...
import static one.innovation.personapi.utils.PersonUtils.asJsonString;
...
public class PersonControllerTest {
    ...
    void testWhenGETWithInvalidIsCalledThenAnErrorMessagenShouldBeReturned() throws Exception {
        ...
        when(personService.findById(expectedValidId)).thenThrow(PersonNotFounfException.class);
